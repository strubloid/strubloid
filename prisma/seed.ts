...
const ZEN_MODELS = [
  ...
  { modelId: 'mimo-v2.5-free',          name: 'MiMo V2.5',                endpoint: '/v1/chat/completions', provider: 'openai', modelSource: 'zen', description: 'Xiaomi fast assistant',         isFree: false, inputPrice: 0.15,  outputPrice: 0.60  },
  { modelId: 'nemotron-3-ultra-free',   name: 'Nemotron 3 Ultra',         endpoint: '/v1/chat/completions', provider: 'openai', modelSource: 'zen', description: 'NVIDIA reasoning',              isFree: false, inputPrice: 0.50,  outputPrice: 2.00  },
];
...
const NVIDIA_MODELS = [
  ...
  { modelId: 'deepseek-ai/deepseek-v4-flash',         name: 'DeepSeek V4 Flash',            endpoint: '/v1/chat/completions', provider: 'openai', modelSource: 'nvidia', description: 'Fast reasoning via NVIDIA NIM', isFree: true,  inputPrice: null,  outputPrice: null  },
  ...
  { modelId: 'nvidia/nemotron-3-ultra-550b-a55b',   name: 'Nemotron 3 Ultra 550B',         endpoint: '/v1/chat/completions', provider: 'openai', modelSource: 'nvidia', description: 'NVIDIA hybrid MoE reasoning',     isFree: false, inputPrice: 0.50,  outputPrice: 2.00  },
  { modelId: 'mistralai/mistral-nemotron',           name: 'Mistral Nemotron',              endpoint: '/v1/chat/completions', provider: 'openai', modelSource: 'nvidia', description: 'Mistral × NVIDIA collaboration',  isFree: false, inputPrice: 0.25,  outputPrice: 1.00  },
];
